...
declare -a alts=(
  ...
  "Terminal UI outputs page screenshot"
  "Terminal UI help overlay screenshot"
  "Terminal UI inputs page screenshot"
  "Terminal UI streams page screenshot"
  "Terminal UI patchbay page screenshot"
  "Terminal UI EQ page screenshot"
  "Terminal UI recording page screenshot"
  "Terminal UI status page screenshot"
  "Terminal UI engine page screenshot"
  "headroomctl command output screenshot"
